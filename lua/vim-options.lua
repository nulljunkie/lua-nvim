...
vim.api.nvim_set_keymap('n', '<leader>w2', ':split<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>w3', ':vsplit<CR>', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap("v", "<S-j>", '<cmd>lua MiniMove.move_selection("down")<cr>', { desc = "Move - selection down" })
vim.api.nvim_set_keymap("v", "<S-h>", '<cmd>lua MiniMove.move_selection("left")<cr>', { desc = "Move - selection left" })
vim.api.nvim_set_keymap("v", "<S-l>", '<cmd>lua MiniMove.move_selection("right")<cr>', { desc = "Move - selection right" })
